...
class TestPdfPage extends StatefulWidget {
  ...
  @override
  State<TestPdfPage> createState() => _TestPdfState();
}

class _TestPdfState extends State<TestPdfPage> {
  String pathPDF = "";
  ...
  Future<File> createFileOfPdfUrl() async {
    ...
    try {
      ...
      // convert the response into a list of bytes using the utf8.decoder
      var bytes = response.toString().codeUnits;
      // var bytes = await request.close();
      print(bytes);
